        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <h1 className="text-xl md:text-2xl font-luxury font-bold tracking-widest uppercase flex items-center gap-2">
              <span className="text-fuchsia-500">Ayzal</span> <span className="text-white">Fathima</span>
            </h1>
          </div>
      ...
      <section className="relative min-h-screen flex items-center bg-black">
        ...
        <div className="relative z-10 px-6 max-w-7xl mx-auto w-full mt-20">
          <div className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="text-xs uppercase tracking-[0.3em] font-modern font-bold text-white">Al Qusais Industrial Area, Dubai</span>
          </div>
          ...
          <p className="text-lg text-zinc-300 font-modern font-light tracking-wide max-w-lg mb-10">
            Hair, skin, threading, nails &amp; bridal makeup by friendly, experienced beauticians — right here in Al Qusais, Dubai.
          </p>
