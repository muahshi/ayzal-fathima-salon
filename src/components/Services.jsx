...
export default function Services() {
  ...
  const services = [
    { title: "Hair & Styling", img: "https://images.unsplash.com/photo-1560066984-138dadb4c035?q=80&w=1887&auto=format&fit=crop", desc: "Haircuts, coloring, keratin, straightening, blow dry & hair spa." },
    { title: "Bridal & Makeup", img: "https://images.unsplash.com/photo-1595959183082-7b570b7e08e2?q=80&w=1936&auto=format&fit=crop", desc: "Bridal & party makeup for your special day, by experienced artists." },
    { title: "Skin & Nails", img: "https://images.unsplash.com/photo-1522337660859-02fbefca4702?q=80&w=2069&auto=format&fit=crop", desc: "Facials, threading, waxing, lash extensions, manicure & gel pedicure." }
  ];
