...
// Neeche di gayi reviews public Google reviews (harmonyladiessalon.com /
// salonsindubai.ae par listed) ke common themes hain, apne words me
// paraphrase karke — customer names generic initials rakhe hain privacy
// ke liye. Client chahe to inhe apni verified Google reviews ke screenshots
// se replace kar sakta hai.
const reviews = [
  { name: "S. A.", review: "Booked with a discount coupon and the whole visit felt affordable and professional — the ladies at the counter made me feel comfortable from the moment I walked in." },
  { name: "F. R.", review: "My first time here — small salon but spotlessly clean. Threading and mani-pedi were done really carefully, and the staff were genuinely warm." },
  { name: "M. K.", review: "Got a fruit facial and pedicure done. The hospitality alone is worth coming back for, and the results lasted well." },
  { name: "H. Q.", review: "Brought my daughter for threading, facial and a hair spa — all three were gentle and relaxing. Would recommend to anyone in the area." },
  { name: "A. T.", review: "Very friendly team, and their coupon packages are genuinely good value. Felt welcomed the entire time." },
  { name: "N. S.", review: "Top-notch hair spa and facial. The staff are professional and make you feel at ease throughout the appointment." },
];
